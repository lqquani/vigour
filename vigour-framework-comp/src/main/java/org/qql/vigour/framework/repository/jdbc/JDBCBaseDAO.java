package org.qql.vigour.framework.repository.jdbc;
...
import org.qql.vigour.framework.repository.jdbc.support.ArgPreparedStatementSetter;
import org.qql.vigour.framework.repository.jdbc.support.ArgTypePreparedStatementSetter;
import org.qql.vigour.framework.repository.jdbc.support.StoredProcedure;
...
public class JDBCBaseDAO extends NamedParameterJdbcDaoSupport {
	...
	@Autowired
	@Resource(name = "vigourDataSource")
