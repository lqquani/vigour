 ...
 */
@Component
public class SSOHxbAuthorizingRealm extends AuthorizingRealm {

	public SSOHxbAuthorizingRealm() {
...
//		if (isSuperUser) {
//			authLogicSysNo = GlobalConstants.SUPER_LOGIC_SYSTEM;
//		}
//		// 获取登录用户的信息
...
//		bioneUser.setAuthTypeNo(GlobalConstants.AUTH_TYPE_LOCAL_SYS);
